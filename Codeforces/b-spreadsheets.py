...
#pegar os caracteres da linha "R" XCX e guardo
letter_index = 0
...
#pegar números da linha r "X" CX e guardo
...
#pegar os caracteres da linha rx "C" x
for char in input_coordinates[letter_index:]:
    if not list_coordinates[letter_index].isdigit():
...
#pegar os números da coluna rxc "X"
for char in input_coordinates[letter_index:]:
    if list_coordinates[letter_index].isdigit():
...
#row_letters =          R
#num_row_coordinates =  X (int)
#column_letters =       C
#num_col_coordinates =  X (int)


#converter de um para outro conforme a sequência de dados
#converter para AX
